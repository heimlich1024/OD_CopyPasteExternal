...
class OD_OT_CopyToExternal(bpy.types.Operator):
    """Object Cursor Array"""
...
def menu_func(self, context):
    self.layout.operator(OD_OT_CopyToExternal.bl_idname)

def register():
    bpy.utils.register_class(OD_OT_CopyToExternal)
    bpy.types.VIEW3D_MT_object.append(menu_func)

def unregister():
    bpy.utils.unregister_class(OD_OT_CopyToExternal)
